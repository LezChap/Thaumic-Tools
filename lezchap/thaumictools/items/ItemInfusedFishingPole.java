...
public class ItemInfusedFishingPole extends ItemTool implements IRepairable, IFishingPole 
{
    ...
    public ItemInfusedFishingPole(int par1, EnumToolMaterial enumtoolmaterial)
    {
    	super(par1, 1.0F, enumtoolmaterial, blocksEffectiveAgainst);
        this.setMaxDamage(253);
